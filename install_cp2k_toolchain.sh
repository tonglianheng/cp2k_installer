...
${BUILDDIR}, and then installed into package specific directories inside
${INSTALLDIR}.

Both ${BUILDDIR} and ${INSTALLDIR} are safe to delete, as they contain
...
files provided by this script, then you must keep ${INSTALLDIR} in exactly
...
the entire ${BUILDDIR} directory.

+--------------------------------------------------------------------+
|  YOU SHOULD ALWAYS SOURCE ${INSTALLDIR}/setup BEFORE YOU RUN CP2K  |
